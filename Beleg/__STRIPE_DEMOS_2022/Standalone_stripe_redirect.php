...
if( $live == 1  ) {
	...
	$public_key_for_js="pk_test_aLcPqdtG2FDzxPWu5N9OBNOs00Yt0nKnhS";  //  PK Großhändler - So lassen !!!!
      ...
      \Stripe\Stripe::setApiKey('sk_test_51NQ9axL1UKreS7PpSf4jhOIc0DlJGFEmWd8FUQPGxCKWtnJfVdXatfx4qyLRi7AoXI3Oi9E8Gg0moAVNilso5THS00fJ8ZlmIA');
	
      $public_key_for_js="pk_test_51NQ9axL1UKreS7PpdYMBUlCU0knxv6cp3EiYGYGTi5xW34hhLmKp5rATeGaUqwUeQaEzh8OAoY1WqRbF1tvrUlov00FVC376eU";  // PK  G00 
}
// #################################################################  
...
try {
    $session = \Stripe\Checkout\Session::create([
       ...
       //'line_items' => [$books[0]],
       'line_items' => [$test],
        'success_url' => 'https://ivm108.informatik.htw-dresden.de/ewa/demos/__STRIPE_DEMOS_2022/' . 'success.php?session_id={CHECKOUT_SESSION_ID}',
        'cancel_url'  => 'https://ivm108.informatik.htw-dresden.de/ewa/demos/__STRIPE_DEMOS_2022/' . 'cancel.php?session_id={CHECKOUT_SESSION_ID}',
    ]);
